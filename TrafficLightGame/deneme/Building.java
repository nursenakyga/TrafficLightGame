...
public class Building extends Pane {
	...
	//Uses this method to set the stroke color for a circle based on the provided color index
	...
	//Uses this method to set the stroke color for a rectangle based on the provided color index.

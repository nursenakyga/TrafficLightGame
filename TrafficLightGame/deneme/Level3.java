	...
	public Level3() throws FileNotFoundException {
		...
		while (scanner.hasNext()) {
			...
			case "Metadata":
				...
				GameBackground background = new GameBackground(width, height, numberOfGridCellsX, numberOfGridCellsY, pathCount ,
						succesfullyArrived, crashedCars);
